 ...
 * @author eder_
 */
public class Frm_en extends javax.swing.JInternalFrame {
    private final entrada EN;
    public static int enviar = 0;
    int num = 0;
    /**
     * Creates new form Frm_en
     */
    public Frm_en() {
        initComponents();
        EN = new entrada();
    ...
    private void listar(){
        jtb_entrada.setModel(EN.getDatosEntradas());
    }
    ...
    private void guardar(){
        ...
        if(num == 0){
            int respuesta = EN.registrarEntrada(nfac,codigo,fecha_sql,cantidad);
            if(respuesta > 0){
                listar();
                limpiar();
                iniciar();
    ...
    private void initComponents() {
        ...
        jbt_buscar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/1150652.png"))); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_descripcion, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jbt_buscar, javax.swing.GroupLayout.DEFAULT_SIZE, 49, Short.MAX_VALUE)
                .addGap(33, 33, 33)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jbt_guardar)
                    .addComponent(bt_nuevo))
